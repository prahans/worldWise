  ...
  const getCity = useCallback(
    ...
    async function createCity(newCity){
      ...
      try{
        ...
        dispatch({type: "rejected", payload : "There was an error uploading city data..."});
      }
    }
...
function useCities(){
    ...
    if(context === undefined) throw new Error("Cities Context was used outside of the post provider");
    return context;
}
